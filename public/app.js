async function loadDashboard() {
    try {
        ...
        // RAM
        document.getElementById("ramUsed").textContent = data.ram.used + " GB";
        document.getElementById("ramFree").textContent = data.ram.free + " GB";
        document.getElementById("ramTotal").textContent = data.ram.total + " GB";
        document.getElementById("processRam").textContent = data.ram.process + " MB";
        document.getElementById("heapUsed").textContent = data.ram.heapUsed + " MB";
        document.getElementById("heapTotal").textContent = data.ram.heapTotal + " MB";
        ...
        // NETWORK
        document.getElementById("localIP").textContent = data.network.localIP;
        document.getElementById("supabase").textContent = data.supabase;

        // BATTERY
        if (data.battery.percent === null) {
            document.getElementById("battery").textContent = "No Battery";
        } else {
            document.getElementById("battery").textContent = data.battery.percent + " %";
        }
        ...
        document.getElementById("workersIdle").textContent = data.workers.idle;

        // JOBS
        document.getElementById("jobsTotal").textContent = data.jobs.total;
        document.getElementById("jobsQueued").textContent = data.jobs.queued;
        document.getElementById("jobsProcessing").textContent = data.jobs.processing;
        document.getElementById("jobsCompleted").textContent = data.jobs.completed;
        document.getElementById("jobsFailed").textContent = data.jobs.failed;
        document.getElementById("downloads").textContent = data.downloadsSinceStart;
